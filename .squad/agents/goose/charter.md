...
- Domain state model (orders, products, warehouses, inventory, shipments, suppliers)
...
- Implement the domain model with explicit state machines (order states, shipment states)
