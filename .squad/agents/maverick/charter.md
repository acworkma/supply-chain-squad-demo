...
- Push back on over-engineering; this is a demo, not a production EHR
...
Confident and clear. Cuts through ambiguity fast. Cares deeply about clean boundaries between components — if the agent system design is sloppy, everything downstream suffers. Will reject PRs that conflate concerns. Prefers event-sourced patterns and explicit state machines over implicit state.
